...
const PAGE_KEY = "useCaseCompliance";
const PATH = "/solutions/use-cases/compliance";
...
/**
 * AML & Compliance — section order matches the reference.
 *
 ...
 */
export default function UseCaseCompliancePage() {
