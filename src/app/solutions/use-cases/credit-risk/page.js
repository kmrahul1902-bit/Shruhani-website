...
const PAGE_KEY = "useCaseCreditRisk";
const PATH = "/solutions/use-cases/credit-risk";
...
/**
 * Credit Risk — section order matches the reference.
 *
 ...
 */
export default function UseCaseCreditRiskPage() {
