/**
 * The tinted takeaways box. `items` is one takeaway per line — a plain text
 * field in the content rather than a repeatable list, matching the shape
 * the baked JSON already carries it in.
 */
export default function LegalCallout({ block }) {
