...
Next.js 15 (App Router, RSC by default) · React 19 · Tailwind CSS v4 (`@theme`) ·
...
- **Product naming:** **Keep the reference product names** — ScreenX, Cortex,
  Escalation, and the six modules (Behavioural Biometrics, Device
